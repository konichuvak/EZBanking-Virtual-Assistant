...
def parse_text(text, client_id):
    # Read the configuration file
    with open('/Users/lawnboymax/Documents/projects/hackathons/conuhacks/chatbot-backend/chatbot/nuance_nlu/creds.json', 'r') as f:
        creds = f.read()
    credentials = json.loads(creds, encoding='utf-8')
